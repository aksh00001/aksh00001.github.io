...
export default function ShaderDemo_ATC() {
    ...
    useEffect(() => {
        ...
        try { prog = link(vertSrc, fragSrc) }
            ...
            console.error("Shader setup error:", e);
    ...
    return (
        <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100vh", zIndex: -1 }}>
            <canvas ref={ref} style={{ width: "100%", height: "100%", display: "block", background: "#050205", filter: "brightness(0.9)" }} />
            <pre ref={preRef} style={{ position: "absolute", top: 8, left: 8, color: "#f00", whiteSpace: "pre-wrap" }} />
        </div>
    )
}
