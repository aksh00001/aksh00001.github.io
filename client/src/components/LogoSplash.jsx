...
export default function LogoSplash({ onComplete }) {
    ...
    return (
        <>
            ...
            <div
                ref={leftHalfRef}
                className="fixed inset-0 z-[9999] bg-[#050205] flex items-center justify-center overflow-hidden"
            >
                {/* Aurora Mesh Gradient Orb */}
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="absolute w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#522B5B]/30 via-[#854F6C]/20 to-transparent blur-3xl animate-pulse"></div>
                    <div className="absolute w-[500px] h-[500px] rounded-full bg-gradient-to-tl from-[#150B1F]/25 via-[#522B5B]/15 to-transparent blur-2xl animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                    <div className="absolute w-[400px] h-[400px] rounded-full bg-gradient-to-r from-[#854F6C]/20 via-[#522B5B]/10 to-transparent blur-xl"></div>
                </div>
                ...
                >
                    ...
                    <div ref={progressContainerRef} className="mt-8 w-64 md:w-80 mx-auto">
                        <div className="h-1 bg-[#150B1F] rounded-full overflow-hidden">
                            <div
                                ref={progressBarRef}
                                className="h-full bg-gradient-to-r from-[#522B5B] to-[#854F6C] rounded-full"
                                style={{ width: '0%' }}
                            ></div>
                        </div>
                    </div>
            ...
            <div
                ref={rightHalfRef}
                className="fixed inset-0 z-[9998] bg-[#050205] flex items-center justify-center overflow-hidden"
            >
                {/* Aurora Mesh Gradient Orb */}
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="absolute w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#522B5B]/30 via-[#854F6C]/20 to-transparent blur-3xl animate-pulse"></div>
